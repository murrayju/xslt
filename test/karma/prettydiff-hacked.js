// THIS IS A HACKED UP COPY OF PRETTYDIFF
// See modifications at end of file. Workaround for https://github.com/prettydiff/prettydiff/issues/435
...
(function prettydiff_init() {
    ...
    if (typeof module === "object" && typeof module.parent === "object") {
        ...
        define(function requirejs(require, module) {
            // This is the hack, need to declare module.exports first to avoid NRE
